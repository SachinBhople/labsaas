...
router
    ...
    .put("/update-ambulance/:id", superAdmin.updateAmbulance)
    .put("/activate-ambulance/:id", superAdmin.activateAmbulance)
    .put("/deactivate-ambulance/:id", superAdmin.deactivateAmbulance)
